##################################################
## manually calculate NA epitope distances (Bhatt mask)
##################################################
...
## bhatt mask
vec <- ""
sites <- stringi::stri_locate_all_fixed(pattern = "1", str = vec)[[1]][, 1]
length(sites) # number of NA ep. sites
...
save(NA_north_amer_dist_epitope_summary, file = "data/NA_mean_bhatt_epitope_change_north_amer_build_summary.Rdata")
