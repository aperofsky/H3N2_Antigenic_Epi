...
p <- ggplot(total_samp) +
  ...
  xlab("Season")
p
# save_plot(p, file = "figures/seasonal_total_specimens_by_region.png", base_width = 14, base_height = 8)
save_plot(p, file = "figures/seasonal_total_specimens_by_region.pdf", dpi = 300, base_width = 14, base_height = 8)
