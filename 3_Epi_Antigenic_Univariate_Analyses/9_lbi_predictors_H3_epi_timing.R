...
# save_plot(lbi_leg_NA, filename = "figures/ha_vs_na_lbi_season_duration.pdf",dpi = 300, base_width = 12, base_height = 6)
...
save_plot(lbi_leg_all, filename = "figures/ha_vs_na_lbi_season_duration.png", base_width = 12, base_height = 10)
save_plot(lbi_leg_all, filename = "figures/ha_vs_na_lbi_season_duration.pdf", dpi=300, base_width = 12, base_height = 11)
