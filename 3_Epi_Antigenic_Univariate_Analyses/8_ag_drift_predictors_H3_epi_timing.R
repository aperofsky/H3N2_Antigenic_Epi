...
save_plot(heat_p2, filename = "figures/epi_timing_evol_heatmap_alternate.pdf", dpi = 300, base_width = 14, base_height = 14)
...
save_plot(epi_timing_fig_leg, filename = "figures/peak_and_onset_epi_timing_north_amer_build.pdf",dpi=300, base_width = 12, base_height = 12)
...
save_plot(all_epi_leg_HA_NA, filename = "figures/ha_vs_na_onset_to_peak.pdf", dpi=300,base_width = 12, base_height = 6)
