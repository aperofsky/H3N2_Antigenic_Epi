...
save_plot(all_epi_leg_all_measures, filename = "figures/LBI_vs_H3_epi_metrics_north_amer_build.pdf", dpi = 300, base_width = 10, base_height = 10)
...
## Figure S8
save_plot(all_epi_leg_all_measures, filename = "figures/std_lbi_vs_H3_epi_metrics_north_amer_build.png", base_width = 10, base_height = 10)
save_plot(all_epi_leg_all_measures, filename = "figures/std_lbi_vs_H3_epi_metrics_north_amer_build.pdf", dpi=300,base_width = 10, base_height = 10)
