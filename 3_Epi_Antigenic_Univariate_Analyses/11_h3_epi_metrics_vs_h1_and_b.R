...
combined3
save_plot(combined3,
  filename = "figures/h1_or_ivb_epi_size_vs_h3_paramters.png",
  base_width = 20, base_height = 10
)

save_plot(combined3,
          filename = "figures/h1_or_ivb_epi_size_vs_h3_paramters.pdf",
          dpi = 300,
          base_width = 20, base_height = 10
)
...
combined2
save_plot(combined2, filename = "figures/h3_vs_h1_or_ivb_epi_size_wavelet.png", base_width = 12, base_height = 6)
save_plot(combined2, filename = "figures/h3_vs_h1_or_ivb_epi_size_wavelet.pdf", dpi = 300, base_width = 12, base_height = 6)
