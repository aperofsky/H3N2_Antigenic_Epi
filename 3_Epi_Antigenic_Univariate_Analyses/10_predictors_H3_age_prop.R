...
save_plot(heat_p2, filename = "figures/age_epi_evol_heatmap_alternate.pdf",dpi=300, base_width = 12, base_height = 10)
...
save_plot(all_epi_leg_all_measures, filename = "figures/all_antigenic_measures_vs_age_patterns_north_amer_build_ha_ep.png", base_width = 18, base_height = 14)
save_plot(all_epi_leg_all_measures, filename = "figures/all_antigenic_measures_vs_age_patterns_north_amer_build_ha_ep.pdf", dpi = 300, base_width = 18, base_height = 14)
