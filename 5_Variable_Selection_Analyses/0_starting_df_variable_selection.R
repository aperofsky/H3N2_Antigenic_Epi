...
#   region, H3_max_intensity,
#   season, year.new,
#   HA_titer_tree_lag2, HA_wolf_lag2, NA_bhatt_ep_lag1, # antigenic drift with strong. correlations
#   ha_lbi_shannon,
#   na_lbi_shannon, # LBI diversity
#   ha_lbi_shannon_lag1,
#   na_lbi_shannon_lag1,
#   HA_mean_lbi_lag1,
#   NA_mean_lbi_lag1,
...
#   IVB_epi_size_prior,
#   vac_combined, # vaccine parameters
#   vac_cov_combined,
#   weighted_VE,
#   vac_combined_prior,
#   vac_cov_combined_prior,
