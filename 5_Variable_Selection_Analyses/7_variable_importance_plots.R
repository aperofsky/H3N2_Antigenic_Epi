...
save_plot(combined_cforest, filename = "figures/cforest_variable_importance_H3_epi_measures.pdf", dpi = 300, base_width = 18, base_height = 10)
...
save_plot(combined_lasso, filename = "figures/lasso_variable_importance_H3_epi_measures.pdf", dpi = 300, base_width = 18, base_height = 10)
...
save_plot(all_resid_plot2, filename = "figures/cond_inf_forest_residual_plots_by_region_and_epi_metric.pdf", dpi = 300, base_width = 15, base_height = 14)
...
save_plot(p, filename = "figures/model_total_rmse_by_metric.pdf", dpi = 300, base_width = 10, base_height = 8)
...
save_plot(p, filename = "figures/model_total_rmse_by_metric_NA.pdf", dpi = 300, base_width = 10, base_height = 8)
